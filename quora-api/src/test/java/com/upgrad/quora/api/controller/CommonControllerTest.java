...
public class CommonPartControllerTest {
    ...
    public void details() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/userprofile/uuid1").header("authorization", "accesstoken"))
    ...
    public void detailsUsingNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/userprofile/uuid1").header("authorization", "non_existing_access_token"))
    ...
    public void detailsOfNonExistingUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/userprofile/non_existing_user").header("authorization", "accesstoken"))
